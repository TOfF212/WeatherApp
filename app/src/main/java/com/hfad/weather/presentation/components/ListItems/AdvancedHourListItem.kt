...
@Composable
fun AdvancedHourListItem(item: Weather, onClick: () -> Unit){
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .alpha(1f)
        ...
        Column ( Modifier
            ...
            Row(
                ...
                Text(
                    text = "Chance Precipitation:${item.chancePrecipitation}", style = TextStyle(fontSize = 20.sp),
                )
                Text(
                    text = "Wind:${item.chancePrecipitation} km/h", style = TextStyle(fontSize = 20.sp),
                )
